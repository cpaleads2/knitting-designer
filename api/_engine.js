...
const PDF_TEXT = {
  en: {
    ...
    gaugeFormat: (stg, rowg) => `${stg} sts / ${rowg} rows per 10 cm`,
  ...
  ru: {
    ...
    gaugeFormat: (stg, rowg) => `${stg} петель / ${rowg} рядов на 10 см`,
  ...
  uk: {
    ...
    gaugeFormat: (stg, rowg) => `${stg} петель / ${rowg} рядів на 10 см`,
